      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <Link
              href="/guides"
              className="ml-4 group inline-flex items-center px-4 py-2 text-sm font-medium text-[var(--destructive-foreground)] bg-[var(--destructive)] rounded-lg hover:bg-[var(--destructive)]/90 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
            >
              Get Started
              <svg
